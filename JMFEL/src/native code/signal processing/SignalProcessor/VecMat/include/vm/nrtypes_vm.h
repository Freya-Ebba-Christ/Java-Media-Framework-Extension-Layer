...
/******************************************************************************
 *
 *  This is a modified version of nrtypes_nr.h for use with the VecMat
 *  software. Note that all typedefs included in the "vm_types.h" header have
 *  been removed from this header.
 *
 *****************************************************************************/
