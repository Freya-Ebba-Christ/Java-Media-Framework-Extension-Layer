#include "media_protocol_gtec_NativeAmplifierB.h"
#include "stdafx.h"
#include <iostream>
using namespace std;
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierB_getHeaderSize(JNIEnv * env, jobject obj){
	return HEADER_SIZE;
}

JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierB_getSizeOfFloat(JNIEnv *env, jobject obj){
	return sizeof(float);
}

JNIEXPORT jfloat JNICALL Java_media_protocol_gtec_NativeAmplifierB_getDriverVersion(JNIEnv *env , jobject obj){
	return GT_GetDriverVersion();
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_probeDevice(JNIEnv *env , jobject obj, jint port){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_openDevice__I(JNIEnv *env , jobject obj , jint iPortNumber){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_openDevice__Ljava_lang_String_2(JNIEnv *env , jobject obj, jstring serial){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_closeDevice(JNIEnv *env , jobject obj){
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierB_getData(JNIEnv *env , jobject obj, jbyteArray buffer){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setBufferSize(JNIEnv *env, jobject obj, jint buffersize){
	return GT_SetBufferSize(amplifier,buffersize);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setSampleRate(JNIEnv *env, jobject obj, jint samplerate){
	return GT_SetSampleRate(amplifier,samplerate);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_start(JNIEnv *env, jobject obj){
	return GT_Start(amplifier);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_stop(JNIEnv *env, jobject obj){
	return GT_Stop(amplifier);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setChannels(JNIEnv *env, jobject obj, jintArray channels){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setDigitalOut(JNIEnv *env, jobject obj, jint port, jboolean flag){
	
	return GT_SetDigitalOut(amplifier,port,flag);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_getDigitalIO(JNIEnv *env, jobject obj, jbooleanArray digital_in, jbooleanArray digital_out){
		DigitalIO myDIO;
...
JNIEXPORT void JNICALL Java_media_protocol_gtec_NativeAmplifierB_getLastError(JNIEnv *env, jobject obj){
	GT_GetLastError(&wErrorCode,&pLastError);
}

JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierB_getLastErrorCode(JNIEnv *env, jobject obj){
	return (jint)wErrorCode;
}

JNIEXPORT jstring JNICALL Java_media_protocol_gtec_NativeAmplifierB_getLastErrorMessage(JNIEnv *env, jobject obj){
	return env->NewStringUTF(&pLastError);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_resetTransfer(JNIEnv *env, jobject obj){
	return GT_ResetTransfer(amplifier);
}

JNIEXPORT jstring JNICALL Java_media_protocol_gtec_NativeAmplifierB_getSerial(JNIEnv *env, jobject obj){
	CString strSerial;
	GT_GetSerial(amplifier, strSerial.GetBuffer(256), 256);
	return env->NewStringUTF(strSerial);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_enableTriggerLine(JNIEnv *env, jobject obj, jboolean flag){
	return GT_EnableTriggerLine(amplifier,flag);
}

JNIEXPORT jdouble JNICALL Java_media_protocol_gtec_NativeAmplifierB_getImpedance(JNIEnv *env, jobject obj, jint channel){
	double impedance;
	GT_GetImpedance(amplifier,(UCHAR)channel,&impedance);
	return impedance;
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_calibrate(JNIEnv *env , jobject obj, jfloatArray factorArray, jfloatArray offsetArray){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setScale(JNIEnv *env, jobject obj, jfloatArray factorArray, jfloatArray offsetArray){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_getScale(JNIEnv *env, jobject obj, jfloatArray factorArray, jfloatArray offsetArray){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_getFilterSpec(JNIEnv *env, jobject obj, jfloatArray filterSpecArray, jint filterID){
		int nof;
		_FILT *filterSpec;
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierB_getNumberOfFilters(JNIEnv *env, jobject obj){
		int nof;
		GT_GetNumberOfFilter(&nof);
		return nof;
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setBandPass(JNIEnv *env, jobject obj, jint filterID, jint channelID){
	return GT_SetBandPass(amplifier,channelID,filterID);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_getNotchFilterSpec(JNIEnv *env, jobject obj, jfloatArray notchFilterSpecArray, jint filterID){
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierB_getNumberOfNotchFilters(JNIEnv *env, jobject obj){
		int nof;
		GT_GetNumberOfNotch(&nof);
		return nof;
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setNotch(JNIEnv *env, jobject obj, jint filterID, jint channelID){
	return GT_SetNotch(amplifier,channelID,filterID);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setMode(JNIEnv *env, jobject obj, jint mode){
/*
	#define M_NORMAL		0
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierB_getMode(JNIEnv *env, jobject obj){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setGround(JNIEnv *env, jobject obj, jbooleanArray gnd_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_getGround(JNIEnv *env, jobject obj, jbooleanArray gnd_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setReference(JNIEnv *env , jobject obj, jbooleanArray ref_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_getReference(JNIEnv *env, jobject obj, jbooleanArray ref_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setBipolar(JNIEnv *env, jobject obj, jintArray channels){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setDRLChannel(JNIEnv *env, jobject obj, jintArray channels){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_enableSC(JNIEnv *env, jobject obj, jboolean flag){
	return GT_EnableSC(amplifier, flag);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setSlave(JNIEnv *env, jobject obj, jboolean flag){
	return GT_SetSlave(amplifier, flag);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierB_setDAC(JNIEnv *env, jobject obj, jbyte waveShape, jint amplitude, jint frequency, jint offset){
