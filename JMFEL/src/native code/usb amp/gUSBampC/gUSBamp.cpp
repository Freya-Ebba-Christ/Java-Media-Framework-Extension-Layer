#include "media_protocol_gtec_NativeAmplifierC.h"
#include "stdafx.h"
#include <iostream>
using namespace std;
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierC_getHeaderSize(JNIEnv * env, jobject obj){
	return HEADER_SIZE;
}

JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierC_getSizeOfFloat(JNIEnv *env, jobject obj){
	return sizeof(float);
}

JNIEXPORT jfloat JNICALL Java_media_protocol_gtec_NativeAmplifierC_getDriverVersion(JNIEnv *env , jobject obj){
	return GT_GetDriverVersion();
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_probeDevice(JNIEnv *env , jobject obj, jint port){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_openDevice__I(JNIEnv *env , jobject obj , jint iPortNumber){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_openDevice__Ljava_lang_String_2(JNIEnv *env , jobject obj, jstring serial){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_closeDevice(JNIEnv *env , jobject obj){
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierC_getData(JNIEnv *env , jobject obj, jbyteArray buffer){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setBufferSize(JNIEnv *env, jobject obj, jint buffersize){
	return GT_SetBufferSize(amplifier,buffersize);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setSampleRate(JNIEnv *env, jobject obj, jint samplerate){
	return GT_SetSampleRate(amplifier,samplerate);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_start(JNIEnv *env, jobject obj){
	return GT_Start(amplifier);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_stop(JNIEnv *env, jobject obj){
	return GT_Stop(amplifier);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setChannels(JNIEnv *env, jobject obj, jintArray channels){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setDigitalOut(JNIEnv *env, jobject obj, jint port, jboolean flag){
	
	return GT_SetDigitalOut(amplifier,port,flag);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_getDigitalIO(JNIEnv *env, jobject obj, jbooleanArray digital_in, jbooleanArray digital_out){
		DigitalIO myDIO;
...
JNIEXPORT void JNICALL Java_media_protocol_gtec_NativeAmplifierC_getLastError(JNIEnv *env, jobject obj){
	GT_GetLastError(&wErrorCode,&pLastError);
}

JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierC_getLastErrorCode(JNIEnv *env, jobject obj){
	return (jint)wErrorCode;
}

JNIEXPORT jstring JNICALL Java_media_protocol_gtec_NativeAmplifierC_getLastErrorMessage(JNIEnv *env, jobject obj){
	return env->NewStringUTF(&pLastError);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_resetTransfer(JNIEnv *env, jobject obj){
	return GT_ResetTransfer(amplifier);
}

JNIEXPORT jstring JNICALL Java_media_protocol_gtec_NativeAmplifierC_getSerial(JNIEnv *env, jobject obj){
	CString strSerial;
	GT_GetSerial(amplifier, strSerial.GetBuffer(256), 256);
	return env->NewStringUTF(strSerial);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_enableTriggerLine(JNIEnv *env, jobject obj, jboolean flag){
	return GT_EnableTriggerLine(amplifier,flag);
}

JNIEXPORT jdouble JNICALL Java_media_protocol_gtec_NativeAmplifierC_getImpedance(JNIEnv *env, jobject obj, jint channel){
	double impedance;
	GT_GetImpedance(amplifier,(UCHAR)channel,&impedance);
	return impedance;
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_calibrate(JNIEnv *env , jobject obj, jfloatArray factorArray, jfloatArray offsetArray){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setScale(JNIEnv *env, jobject obj, jfloatArray factorArray, jfloatArray offsetArray){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_getScale(JNIEnv *env, jobject obj, jfloatArray factorArray, jfloatArray offsetArray){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_getFilterSpec(JNIEnv *env, jobject obj, jfloatArray filterSpecArray, jint filterID){
		int nof;
		_FILT *filterSpec;
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierC_getNumberOfFilters(JNIEnv *env, jobject obj){
		int nof;
		GT_GetNumberOfFilter(&nof);
		return nof;
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setBandPass(JNIEnv *env, jobject obj, jint filterID, jint channelID){
	return GT_SetBandPass(amplifier,channelID,filterID);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_getNotchFilterSpec(JNIEnv *env, jobject obj, jfloatArray notchFilterSpecArray, jint filterID){
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierC_getNumberOfNotchFilters(JNIEnv *env, jobject obj){
		int nof;
		GT_GetNumberOfNotch(&nof);
		return nof;
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setNotch(JNIEnv *env, jobject obj, jint filterID, jint channelID){
	return GT_SetNotch(amplifier,channelID,filterID);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setMode(JNIEnv *env, jobject obj, jint mode){
/*
	#define M_NORMAL		0
...
JNIEXPORT jint JNICALL Java_media_protocol_gtec_NativeAmplifierC_getMode(JNIEnv *env, jobject obj){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setGround(JNIEnv *env, jobject obj, jbooleanArray gnd_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_getGround(JNIEnv *env, jobject obj, jbooleanArray gnd_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setReference(JNIEnv *env , jobject obj, jbooleanArray ref_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_getReference(JNIEnv *env, jobject obj, jbooleanArray ref_array){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setBipolar(JNIEnv *env, jobject obj, jintArray channels){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setDRLChannel(JNIEnv *env, jobject obj, jintArray channels){
...
JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_enableSC(JNIEnv *env, jobject obj, jboolean flag){
	return GT_EnableSC(amplifier, flag);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setSlave(JNIEnv *env, jobject obj, jboolean flag){
	return GT_SetSlave(amplifier, flag);
}

JNIEXPORT jboolean JNICALL Java_media_protocol_gtec_NativeAmplifierC_setDAC(JNIEnv *env, jobject obj, jbyte waveShape, jint amplitude, jint frequency, jint offset){
